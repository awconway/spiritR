...
create_ctxml %>% 
  xml2::xml_find_first(".//brief_summary") %>%
...
create_ctxml %>% 
  xml2::xml_find_first(".//detailed_description") %>%
...
create_ctxml %>% 
  xml2::xml_find_first(".//model_description") %>%  
...
create_ctxml %>% 
  xml2::xml_find_first(".//masking_description") %>%  
...
create_ctxml %>% 
  xml2::xml_find_first(".//study_design") %>%
...
create_ctxml %>% 
  xml2::xml_find_first(".//intervention_description") %>% 
...
create_ctxml %>% 
  xml2::xml_find_first(".//study_population") %>% 
...
create_ctxml %>% 
  xml2::xml_find_first(".//gender_description") %>%  
...
create_ctxml %>% 
  xml2::xml_find_first(".//overall_official") %>% 
...
create_ctxml %>% 
  xml2::xml_find_first(".//overall_contact") %>% 
...
create_ctxml %>% 
  xml2::xml_find_first(".//overall_contact_backup") %>%
...
create_ctxml %>% 
  xml2::xml_find_first(".//ipd_description") %>%
