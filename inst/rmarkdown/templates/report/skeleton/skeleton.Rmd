...
```{r}
# These are objects that can be assigned to auto-populate sections of the table in this protocol but are not required to be entered into the create_ctxml() function to be uploaded to clinicaltrials.gov
primary_registry <-   
...
overall_status =
startDate =
primaryCompletion <-  # anticipated date written in yyyy-mm format. The date that the final participant was examined or received an intervention for the purposes of final collection of data for the primary outcome
...
=======
```{r}
>>>>>>> 4480be2e5f3143e585042fad343663eca5d6499b
