...
| Central contact   	         | `r paste(args_ctxml[contact_first_name], args_ctxml[contact_last_name], sep=" ")`|
| Study official               | `r paste(args_ctxml[official_first_name], args_ctxml[official_last_ame],sep=" ")`|
| Brief title                  | `r args_ctxml[brief_title]`                                          |
| Acronym                      | `r args_ctxml[study_acronym]`                                        |
| Countries of recruitment     | [enter details]   	                                     |
| Condition(s) or study focus  | `r paste(condition_1, keyword_1, sep = ";")`            |
| **Interventions**            |                                                         |
...
| Primary purpose              | `r args_ctxml[interventional_subtype]`                               |
...
| Outcomes Assessor            | `r args_ctxml[masked_assesor]`	                                     |
| **Date of enrollment**       | `r args_ctxml[start_date]`  	                                       |
...
*Description*: `r pr_outcome_description_1`
...
`r args_ctxml[contact_phone]`
`r args_ctxml[contact_email]`
